...
public class MutantLogic {
    ...
    public static void tickTentacles(ZombieEntity z) {
        ...
        if (!(((oas.work.lethalbreed.mixin.EntityAccessor)z).getWorld() instanceof ServerWorld world)) return;
    ...
    public static void onDeath(ZombieEntity z) {
        ...
        ServerWorld world = (ServerWorld) ((oas.work.lethalbreed.mixin.EntityAccessor)z).getWorld();
