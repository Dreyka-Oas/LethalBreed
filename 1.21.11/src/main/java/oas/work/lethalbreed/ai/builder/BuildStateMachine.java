...
public class BuildStateMachine {
    ...
    public void tick() {
        ...
        if (state == 0) {
            ...
            boolean hasVisualTarget = zombie.getTarget() != null && zombie.getSensing().hasLineOfSight(zombie.getTarget());
    ...
    public boolean canUse() { return BuildConditions.canStart(zombie, state, targetLogic) || targetLogic.hasSound(zombie); }
