...
public class ReloadCommand {
    public static int run(CommandContext<ServerCommandSource> context) {
        ...
        try {
            source.getPlayer().sendMessage(new net.minecraft.text.LiteralText("§6[LethalBreed] §aConfig reloaded! §e" + count + " zombies updated."), false);
        } catch (com.mojang.brigadier.exceptions.CommandSyntaxException e) {
            source.sendFeedback(new net.minecraft.text.LiteralText("[LethalBreed] Config reloaded! " + count + " zombies updated."), false);
        }
