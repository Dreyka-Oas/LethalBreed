...
public class ReloadCommand {
    public static int run(CommandContext<CommandSourceStack> context) {
        ...
        try {
            source.getPlayerOrException().displayClientMessage(new net.minecraft.network.chat.TextComponent("§6[LethalBreed] §aConfig reloaded! §e" + count + " zombies updated."), false);
        } catch (com.mojang.brigadier.exceptions.CommandSyntaxException e) {
            source.sendSuccess(new net.minecraft.network.chat.TextComponent("[LethalBreed] Config reloaded! " + count + " zombies updated."), false);
        }
