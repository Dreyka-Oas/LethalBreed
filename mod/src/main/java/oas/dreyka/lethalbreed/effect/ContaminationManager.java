package oas.dreyka.lethalbreed.effect;

import oas.dreyka.lethalbreed.effect.contamination.ContaminationDeath;
...
import oas.dreyka.lethalbreed.effect.contamination.ContaminationTick;
 ...
 *       stale (so a lapse such as milk's redirect, which restores it within the same call, is corrected), the
 ...
 * shared state, and behavior live under {@code oas.dreyka.lethalbreed.effect.contamination} (state, episodes,
...
public final class ContaminationManager {
    ...
    /** See {@link ContaminationLifecycle#onLoad}. */
