...
import oas.dreyka.lethalbreed.effect.contamination.symptom.ContaminationEvolve;
...
public final class SymptomEffects {
    ...
    public static void apply(LivingEntity e, ServerLevel level, long t) {
        ...
        if (cur == null) {
            oas.dreyka.lethalbreed.effect.contamination.ContaminationLifecycle.cure(e);
            return;
        }
