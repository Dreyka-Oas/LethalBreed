...
import oas.dreyka.lethalbreed.effect.contamination.symptom.ContaminationEpisodes;
 ...
 *
 * <p>The plague-forcing tools moved to {@code oas.dreyka.lethalbreed.dev.contam.DevContam} (src/dev),
...
public final class ContaminationLifecycle {
    ...
    public static void onLoad(Entity e) {
        ...
        if (e instanceof LivingEntity le && ContaminationState.age(le) > 0) {
            ...
            // Put the victim's saved deadlines back in the timer maps. Without this a reopened world hands it
