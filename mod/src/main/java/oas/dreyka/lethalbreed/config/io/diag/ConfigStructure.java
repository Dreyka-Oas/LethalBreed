package oas.dreyka.lethalbreed.config.io.diag;
...
public final class ConfigStructure {
    ...
    public static ConfigDrift.Report check(JsonObject root, Set<String> knownNames) {
        ...
        for (Map.Entry<String, JsonElement> entry : root.entrySet()) {
            ...
            if (!value.isJsonObject()) {
                ...
                if (knownNames.contains(key)) {
                    ...
                    RenameRepair.collect(key, knownNames, present, candidates, targets, claims);
                }
                continue;
            }
        ...
        return new ConfigDrift.Report(keysInFile, recognised,
