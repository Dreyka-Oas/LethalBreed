...
public final class WorldSpawnConfig {
    ...
    public static double varHealthMin = 0.9, varHealthMax = 1.2;
    ...
    /** Global hard amplifier ceiling that applies to BOTH the legacy roll AND the phase effects (capped via
