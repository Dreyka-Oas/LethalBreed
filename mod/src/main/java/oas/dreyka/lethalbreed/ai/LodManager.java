...
import oas.dreyka.lethalbreed.util.target.TargetSelector;
...
import static oas.dreyka.lethalbreed.util.Scalars.sq;
...
public final class LodManager {
    ...
    public static LodLevel classify(SmartZombie sz, ServerLevel level,
                                    oas.dreyka.lethalbreed.spatial.TargetIndex index) {
