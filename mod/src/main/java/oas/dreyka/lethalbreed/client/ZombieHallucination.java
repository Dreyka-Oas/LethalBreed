...
public final class ZombieHallucination {
    ...
    /** True while a zombie-vision hallucination episode is active on the local player (flares on an
     *  independent random timer, server-side; synced as the transient ZOMBIE_VISION effect). */
