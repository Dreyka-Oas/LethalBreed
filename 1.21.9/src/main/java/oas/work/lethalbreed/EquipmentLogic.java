...
public class EquipmentLogic {
    ...
    private static void enchant(Zombie z, ItemStack s, int level) {
        EnchantmentHelper.enchantItem(z.getRandom(), s, level, z.level().registryAccess(), java.util.Optional.empty());
    }
    ...
    public static void reequip(Zombie zombie) {
        ...
        zombie.setItemInHand(net.minecraft.world.InteractionHand.MAIN_HAND, ItemStack.EMPTY);
