...
public class PanicLogic {
    ...
    public static void alertAllies(ZombieEntity zombie) {
        ...
        var world = (ServerWorld) ((oas.work.lethalbreed.mixin.EntityAccessor)zombie).getWorld();
    ...
    public static int getPackSize(ZombieEntity zombie) {
        return ((oas.work.lethalbreed.mixin.EntityAccessor)zombie).getWorld().getEntitiesByClass(ZombieEntity.class, 
