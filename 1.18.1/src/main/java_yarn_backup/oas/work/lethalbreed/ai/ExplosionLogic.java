...
public class ExplosionLogic {
    public static void spawnParticles(ZombieEntity z, float bonus, int fuse) {
        ...
        if (bonus > 1.7f) {
            ...
            if (fuse % 5 == 0) z.playSound(SoundEvents.BLOCK_NOTE_BLOCK_BIT, 0.5f, 2.0f);
        }
    }
    ...
    public static void detonate(ZombieEntity z, float bonus) {
        ...
        z.getWorld().createExplosion(z, z.getX(), z.getY(), z.getZ(), power, Explosion.DestructionType.BREAK);
        z.discard();
    }
}
